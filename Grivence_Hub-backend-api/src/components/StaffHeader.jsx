...
/**
 * StaffHeader — restricted header for DEPT_HEAD role.
 * Shows specific department name and icon.
 */
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-white m-0 leading-tight flex items-center gap-2">
              CMS {deptName} Department Portal
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-white m-0">{user?.full_name || 'Staff'}</p>
